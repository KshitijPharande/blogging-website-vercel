    ...
    return (
        <AnimationWrapper>
            {loading ? (
                ...
                <BlogContext.Provider value={{ blog, setBlog, islikedByUser, setLikedByUser,commentsWrapper, setCommentsWrapper, totaParentCommentsLoaded,setTotalParentCommentsLoaded }}>
                    <CommentsContainer/>
